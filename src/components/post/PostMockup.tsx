          ...
          {platform === 'instagram' ? (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 p-3 border-b border-cream-200">
                ...
                <div>
                  <p className="text-xs font-semibold text-brown">your_wreath_shop</p>
                  <p className="text-[10px] text-brown-light">Your Location</p>
                </div>
              </div>
              {/* Image */}
              ...
              <div className="p-3">
                ...
                <p className="text-xs text-brown mb-1">
                  <span className="font-semibold">your_wreath_shop</span>{' '}
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mt-3">
                  <div className="w-6 h-6 rounded-full bg-sage-200 flex items-center justify-center text-[10px] font-bold text-sage-700">W</div>
                  <span className="text-[10px] text-brown-light">Your Wreath Shop</span>
                </div>
              </div>
            </motion.div>
          )}
